...
"""
Monotonic stacks are a twist on the regular stack data structure. Instead of just adding elements in a last-in-first-out way, a monotonic stack keeps its elements in a sorted order—either strictly increasing or decreasing. When you push a new element, you pop off any items that would break that order. This is super handy for problems like finding the next greater or smaller element in an array.
...
"""
Stacks store data in a last-in-first-out order. They're commonly used sorting and searching problems.
"""
